package com.example.classmanagerandroid.Views.Register.PrivacyPolicies

import androidx.lifecycle.ViewModel

class MainViewModelPrivacyPolicies: ViewModel() {


    //Strings
    val privacyPoliciesTitle = "Nuestras políticas de privacidad"
    val privacyPoliciesText = "Su privacidad es importante para nosotros. Es política de Class Manager respetar su privacidad y cumplir con cualquier ley y " +
    ...
    val logDataTitle = "Registro de datos"
    val logDataText = "Cuando visita nuestro sitio web, nuestros servidores pueden registrar automáticamente los datos estándar proporcionados\n" +
    ...
    val userInformationTitle = "Colección y uso de información"
    val userInformationText = "Podemos recopilar información personal de usted cuando realiza cualquiera de las siguientes acciones en nuestro sitio web:\n" +
    ...
    val securityInformationTitle = "Seguridad sobre tu información personal"
    val securityInformationText = "Cuando recopilamos y procesamos información personal, y mientras conservamos esta información, la protegeremos dentro de medios comercialmente aceptables para evitar pérdidas y robos, así como acceso, divulgación, copia, uso o modificación no autorizados.\n" +
    ...
    val internationalInformationTitle = "Transferencia internacional de información personal"
    val internationalInformationText = "La información personal que recopilamos se almacena y / o procesa donde nosotros o nuestros socios, afiliados y proveedores externos tenemos instalaciones. " +
    ...
    val cookiesTitle = "Uso de Cookies"
    val cookiesText = "Usamos \"cookies\" para recopilar información sobre usted y su actividad en nuestro sitio. Una cookie es un pequeño fragmento de datos que nuestro sitio web almacena en su computadora y al que accede cada vez que lo visita, para que podamos comprender cómo utiliza nuestro sitio. Esto nos ayuda a ofrecerle contenido según las preferencias que haya especificado."
    val limitsTitle = "Límites de nuestra política"
    val limitsText = "Nuestro sitio web puede tener enlaces a sitios externos que no son operados por nosotros. Tenga en cuenta que no tenemos control sobre el contenido y las políticas de esos sitios, y no podemos aceptar responsabilidad u obligación por sus respectivas prácticas de privacidad."
    val policityChangesTitle = "Cambios sobre la política"
    val policityChangesText = "At our discretion, we may change our privacy policy to reflect updates to our business processes, current acceptable practices, or legislative or regulatory changes. If we decide to change this privacy policy, we will post the changes here at the same link by which you are accessing this privacy policy.\n" +
    ...
    val contactUsTitle = "Contacte con nosotros"
    val contactUsText = "Para cualquier pregunta o inquietud con respecto a su privacidad, puede comunicarse con nosotros utilizando los siguientes detalles:"
    val contactUsName = "Nombre: Daniel Sainero Compañ"
    val contactUsMail = "Correo: danielSainero.d@gmail.com"
}